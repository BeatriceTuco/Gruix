...
public class CanvasBoardView extends View {
    ...
    private void restartGame() {
        ...
        if (settingsPreferences.getBoolean("gruix_computer_plays_first", true)) {
            playComputer();
        } else {
            userTurn = true;
        }
    ...
    private void playVibration(long duration) {
        if (settingsPreferences.getBoolean("gruix_vibration_enabled", true)) {
            try {
    ...
    private void playSound() {
        if (settingsPreferences.getBoolean("gruix_sound_enabled", true)) {
            try {
